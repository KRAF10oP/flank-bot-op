...
async def invite(ctx):
	embed = discord.Embed(title=f"Invite {client.user.name}", color=0x2f3136, description=f"[Click Here To Invite](https://discord.com/api/oauth2/authorize?client_id=938345769486925885&permissions=8&scope=bot%20applications.commands)")
	await buttons.send(
		content = None,
		embed = embed,
		...
		components = [
			ActionRow([
				Button(
					...
					label = "Invite",
					url = f"https://discord.com/api/oauth2/authorize?client_id=938345769486925885&permissions=8&scope=bot%20applications.commands"
				)
			])
		]
	) 
...
@client.command()
async def vote(ctx):
	embed = discord.Embed(title=f"Vote {client.user.name}", color=0x2f3136, description=f"[Click Here To Vote](https://top.gg/bot/938345769486925885/vote)")
	await buttons.send(
		content = None,
		embed = embed,
		channel = ctx.channel.id,
		components = [
			ActionRow([
				Button(
					style = ButtonType().Link,
					label = "Vote",
					url = f"https://top.gg/bot/938345769486925885/vote"
				)
			])
		]
	) 
...
async def utility(ctx):
    ...
    embed.add_field(name="<:bt_announcements:944623279208022086> Invite", value="```Give's bot invite link```" , inline = False)
    embed.add_field(name="<:bt_announcements:944623279208022086> Vote", value="```Give's bot vote link```" , inline = False)
...
async def help(ctx):
    ...
    embed.add_field(name="<a:bt_setting:938791023230980098> Setup", value="```Bot is auto-setuped so you dont need to run any other command like $setup```" , inline = False)
...
@slash.slash(description="sends bot vote link")
async def vote(ctx):
	embed = discord.Embed(title=f"Vote {client.user.name}", color=0x2f3136, description=f"[Click Here To Vote](https://top.gg/bot/938345769486925885/vote)")
	await buttons.send(
		content = None,
